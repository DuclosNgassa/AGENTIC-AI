...
"""
            ...
            # Stage 2: Health summary and African diet plan
            diet_prompt = f"""
You are a clinical nutritionist specializing in African dietary habits.

Based on the blood work analysis below, provide two clearly separated sections:

SECTION 1 - HEALTH SUMMARY:
Write 3 lines explaining the patient's condition in simple, non-technical language.

SECTION 2 - AFRICAN DIET PLAN:
List foods to eat more of and foods to avoid, using commonly available African foods
like yams, rice, etc. Keep it practical and concise.
...
"""
        ...
        if "SECTION 2" in full_response:
            ...
            diet_plan = ("SECTION 2" + parts[1]).replace("SECTION 2 - AFRICAN DIET PLAN:", "").replace("SECTION 2", "").strip()
        else:
